package com.kagaconnect.layouts;
...
import static com.kagaconnect.layouts.ExpandableLayout.State.COLLAPSED;
import static com.kagaconnect.layouts.ExpandableLayout.State.COLLAPSING;
import static com.kagaconnect.layouts.ExpandableLayout.State.EXPANDED;
import static com.kagaconnect.layouts.ExpandableLayout.State.EXPANDING;
...
public class ExpandableLayout extends FrameLayout {
    ...
    public ExpandableLayout(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            duration = a.getInt(R.styleable.ExpandableLayout_expandable_duration, DEFAULT_DURATION);
            expansion = a.getBoolean(R.styleable.ExpandableLayout_expandable_expanded, false) ? 1 : 0;
            orientation = a.getInt(R.styleable.ExpandableLayout_android_orientation, VERTICAL);
            parallax = a.getFloat(R.styleable.ExpandableLayout_expandable_parallax, 1);
            a.recycle();
