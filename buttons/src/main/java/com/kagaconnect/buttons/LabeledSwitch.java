...
public class LabeledSwitch extends ToggleableView {
    ...
    private void initProperties(AttributeSet attrs) {
        TypedArray tarr = getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.ToggleButton,0,0);
        final int N = tarr.getIndexCount();
        for (int i = 0; i < N; ++i) {
            int attr = tarr.getIndex(i);
            if (attr == R.styleable.ToggleButton_toggle_on) {
                isOn = tarr.getBoolean(R.styleable.ToggleButton_toggle_on, false);
            } else if (attr == R.styleable.ToggleButton_toggle_colorOff) {
                colorOff = tarr.getColor(R.styleable.ToggleButton_toggle_colorOff, Color.parseColor("#FFFFFF"));
                ...
                colorBorder = tarr.getColor(R.styleable.ToggleButton_toggle_colorBorder, accentColor);
                ...
                colorOn = tarr.getColor(R.styleable.ToggleButton_toggle_colorOn, accentColor);
            } else if (attr == R.styleable.ToggleButton_toggle_colorDisabled) {
                colorDisabled = tarr.getColor(R.styleable.ToggleButton_toggle_colorOff, Color.parseColor("#D3D3D3"));
            } else if (attr == R.styleable.ToggleButton_toggle_textOff) {
                labelOff = tarr.getString(R.styleable.ToggleButton_toggle_textOff);
            } else if (attr == R.styleable.ToggleButton_toggle_textOn) {
                labelOn = tarr.getString(R.styleable.ToggleButton_toggle_textOn);
